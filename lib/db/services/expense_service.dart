...
abstract class ExpenseServiceBase {
  ...
  Future<int> createCategory(ExpenseModel category);
...
class ExpenseService implements ExpenseServiceBase {
  ...
  Future<BuiltList<ExpenseModel>> getAllCategories() async {
    ...
    res.forEach((cat) {
      var category = serializers.deserializeWith<ExpenseModel>(
  ...
  @override
  Future<int> createCategory(ExpenseModel category) async {
